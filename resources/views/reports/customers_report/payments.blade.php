    ...
    <div class="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                    ...
                    <a class="breadcrumb-item" href="{{route('report.customers_report')}}">{{__('page.customers_report')}}</a>
                    <a class="breadcrumb-item active" href="#">{{__('page.payments')}}</a>
            </nav>
        </div>
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5"><i class="fa fa-credit-card"></i> {{__('page.customer_payments')}}</h4>
        </div>
            ...
            <div class="br-section-wrapper">                
                <div class="ht-md-40 pd-x-20 bg-gray-200 rounded d-flex align-items-center">
                    <ul class="nav nav-outline align-items-center flex-column flex-md-row" role="tablist">
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="{{route('report.customers_report.sales', $customer->id)}}" role="tab">{{__('page.sales')}}</a></li>
                        <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="{{route('report.customers_report.payments', $customer->id)}}" role="tab">{{__('page.payments')}}</a></li>
                    </ul>
                </div>
                <div class="mt-2">
