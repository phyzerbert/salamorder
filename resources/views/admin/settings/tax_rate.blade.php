    ...
    <div class="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                <a class="breadcrumb-item active" href="#">{{__('page.tax_rate')}}</a>
            </nav>
        </div>
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5"><i class="fa fa-star-half-o"></i> {{__('page.tax_rate_management')}}</h4>
        </div>
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="py-1">
                                        ...
                                        <a href="{{route('tax_rate.delete', $item->id)}}" class="btn btn-danger btn-icon rounded-circle mg-r-5" data-id="{{$item->id}}" onclick="return window.confirm('{{__('page.are_you_sure')}}')"><div><i class="fa fa-trash-o"></i></div></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
